...
User Function fPrintPDF() 
	...
	Local cLocal         := "D:\TOTVS 12\Microsiga\protheus_data\RELINWEB\"
    ...
    oPrinter:= FWMSPrinter():New('RQ0003A.PD_', IMP_PDF, lAdjustToLegacy,cLocal, lDisableSetup, , , , , , .F., )
    cFilePrint := cLocal + "RQ0003A.PD_"
    oPrinter:cPathPDF:= cLocal + "RQ0003a.PDF"
    oPrinter:Preview()
